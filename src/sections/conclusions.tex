...
by utilizing Newton’s interpolation series for backward finite differences
of powers.
In addition, we noticed that backward differences are closely related to
Stirling numbers of the second kind, and Eulerian numbers.
Thus, we expressed formulas for sums of powers in terms of Stirling numbers
...
at~\cite{kolosov_2025_18102534}, which includes
development of generalized algorithm for sums of powers using interpolation
