...
\begin{proposition}
    \begin{mdframed}
        \begin{align*}
            \KnuthRFoldSum{1}{n}{m} &= \sum_{j=0}^{m} \sum_{k=0}^{m} \binom{j+n}{j+1}  \binom{t+k-j}{m-j} \eulerian{m}{k}
        \end{align*}
    \end{mdframed}
\end{proposition}
...
\begin{proposition}
    \begin{mdframed}
        \begin{align*}
            \KnuthRFoldSum{1}{n}{m} &= \sum_{j=0}^{m} \sum_{k=j}^{m} \binom{j+n}{j+1} \binom{t-j}{k-j} \stirlingii{m}{k} k!
        \end{align*}
    \end{mdframed}
\end{proposition}
...
\begin{proposition}[Multifold sum of zero powers]
    ...
    \end{proof}
\end{proposition}
Thus $\KnuthRFoldSum{r-1-s}{n}{0} = \binom{r-s+n-2}{r-s-1}$, which implies
\begin{proposition} [Multifold sums of powers via backward difference binomial form]
